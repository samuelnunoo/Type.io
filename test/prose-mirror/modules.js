...
},{"orderedmap":1}],3:[function(require,module,exports){
'use strict';
...
},{"prosemirror-model":2}],4:[function(require,module,exports){
'use strict';
...
},{"prosemirror-model":2,"prosemirror-transform":7}],5:[function(require,module,exports){
'use strict';
...
},{"prosemirror-model":2,"prosemirror-transform":7}],6:[function(require,module,exports){
'use strict';
...
function takeAttrs(attrs, args) {
  var a0 = args[0];
  if (!args.length || (a0 && (typeof a0 == "string" || a0 instanceof prosemirrorModel.Node || a0.flat)))
    { return attrs }
...
var testSchema = new prosemirrorModel.Schema({
...
},{"prosemirror-model":2,"prosemirror-schema-basic":3,"prosemirror-schema-list":4}],7:[function(require,module,exports){
'use strict';
...
},{"prosemirror-model":2}],8:[function(require,module,exports){
'use strict';
...
editHandlers.drop = function (view, e) {
  ...
  if (view.someProp("handleDrop", function (f) { return f(view, e, slice || prosemirrorModel.Slice.empty, dragging && dragging.move); })) {
    e.preventDefault();
    return
  }
  if (!slice) { return }
...
},{"prosemirror-model":2,"prosemirror-state":5,"prosemirror-transform":7}],9:[function(require,module,exports){
const builder = require('prosemirror-test-builder')
const { EditorState } = require('prosemirror-state')
const { Schema } = require('prosemirror-model')
const { EditorView } = require('prosemirror-view')

},{"prosemirror-model":2,"prosemirror-state":5,"prosemirror-test-builder":6,"prosemirror-view":8}]},{},[9]);
